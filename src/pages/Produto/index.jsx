...
export const Produto = () => {
    ...
    function onSubmit(e) {
        ...
        produto.promo != 0 ? valor = produto.promo : valor = produto.valor;
    ...
    return(
     ...
     <div className="row">
         <div className="col-12 col-md-4 text-center">
             ...
             {produto.promo != 0 ? 
                    <div>
                        De: <span className="cortado">{formataValor(produto.valor)}</span>
                        <br/>
                        <p className="valor">Por: {formataValor(produto.promo)}</p>
                    </div>
                    :
                    ...
                    <form name="formComprar" onSubmit={onSubmit}>
                        <input type="number" name="quantidade" id="quantidade" className="form-control"
